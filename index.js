...
const components = [
  {
    component: require('./app/lib/components/buttons/buttons'),
    name: 'Buttons',
    description: require('./app/lib/components/buttons/README.md'),
    props: {
      text: 'Button'
    },
    modifiers: [
  ...
  {
    component: require('./app/lib/components/button-actions/button-actions'),
    name: 'Button Actions',
    description: require('./app/lib/components/button-actions/README.md'),
    props: {
  ...
  {
    component: require('./app/lib/components/labels/labels'),
    name: 'Labels',
    description: require('./app/lib/components/labels/README.md'),
    props: {
  ...
  {
    component: require('./app/lib/components/tags/tags'),
    name: 'Tags',
    description: require('./app/lib/components/tags/README.md'),
    props: {
      text: 'Tag de muestra',
      link: '/url-de-categoria-opcional/'
    }
  ...
  {
    component: require('./app/lib/components/tooltips/tooltips'),
    name: 'Tooltips',
    description: require('./app/lib/components/tooltips/README.md'),
    props: {
  ...
  {
    component: require('./app/lib/components/image-container/image-container'),
    name: 'Imagen de producto',
    description: require('./app/lib/components/image-container/README.md'),
    props: {
      link: 'link-opcional',
  ...
  {
    component: require('./app/lib/components/value/value'),
    name: 'Precio',
    description: require('./app/lib/components/value/README.md'),
    props: {
  ...
  {
    component: require('./app/lib/components/icons/icons'),
    name: 'Íconos',
    description: require('./app/lib/components/icons/README.md'),
    modifiers: [
      'icon-close',
      'icon-bag',
      'icon-bank',
